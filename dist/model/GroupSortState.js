sap.ui.define([
	...
	return BaseObject.extend("Fiori.SO_Detail.model.GroupSortState", {
		 ...
		 * @alias Fiori.SO_Detail.model.GroupSortState
		 */
		...
		/**
		 * Groups by netwr, or resets the grouping for the key "None"
		 *
		 * @param {string} sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
		group: function (sKey) {
			...
			if (sKey === "netwr") {
				...
				this._oViewModel.setProperty("/sortBy", "netwr");
				...
				this._oViewModel.setProperty("/sortBy", "vbeln");
			}
